import { Action, ActionPanel, closeMainWindow, Icon, List, open, openExtensionPreferences, getPreferenceValues } from "@raycast/api";
...
const formatPropertyValue = (value: string, formatType?: string): string => {
  ...
  switch (formatType) {
    ...
    case "percentage": {
      ...
      return !isNaN(pct)
        ? new Intl.NumberFormat('en-US', { style: 'percent' }).format(pct/100)
        : value;
    }
    default:
      return value;
